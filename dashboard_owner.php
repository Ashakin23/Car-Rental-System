...
<html>
	...
	<body style="background:#E9E9E9;">
		<?php
		    ...
		    $sql = "SELECT username,fullname,email,phone FROM owner_cred WHERE username='$username';";
					...
					<div class="col-md-8">
						<div class="card mb-3" style="padding:50px;">
							<div class="card-body">
                                ...
                                <hr>
                                <button type="button" class="btn btn-dark">Add Cars <strong>+</strong></button>
		...
		<button class="button login__submit btn btn-primary" type="submit" name = 'logout 'value="logout" style="padding:10px 20px;">
